    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function (type) {
            ...
            function popupDate(e) {
                ...
                _self.intialvalue = _self.trigger.value;
                //_self.trigger.value = "";
                //_self.trigger.focus();
            }
            //初始化年月日插件默认值
            ...
            function closeMobileCalendar(e) {
                ...
                _self.gearDate = null;
                _self.trigger.value=_self.intialvalue;
            }
            //确定使用的取消
            function closeMobileCalendar2(e) {
                e.preventDefault();
                var evt;
                try {
                    evt = new CustomEvent('input');
            ...
            function finishMobileDate(e) {
                ...
                closeMobileCalendar2(e);
                _self.submitCallback(_self.trigger.value);
            }
            //年月确认
